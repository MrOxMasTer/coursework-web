...
export const CartCard = ({ product, children, size }: CartCard) => {
  ...
  return (
    <div className="flex bg-linear-[144deg] from-0% to-100% from-white to-white shadow-[0_6px_20px_0_rgba(210,_210,_210,_0.25)] justify-between h-[100px] rounded-[14px]">
      <div className="flex justify-start gap-2">
        <div className="w-[100px] h-full bg-linear-[135deg] from-0% from-wild-sand to-100% to-alabaster rounded-l-[14px] shrink-0">
          {/* <Image></Image> */}
        </div>
